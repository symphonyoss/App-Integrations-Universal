 ...
 */
@Component
public class SimpleWebHookParserResolver extends WebHookParserResolver {

  @Autowired
  private List<SimpleWebHookParserFactory> factories;

  /**
   * Retrieve all parser factories of Simple Webhook integration for all MessageML versions.
